...
**ID3v2 version**
   ...
   .. only:: latex
      ...
      Other than native support for multi-valued tags in v2.4, the :doc:`Picard Tag Mapping <../appendices/tag_mapping_pdf>`
      section will show you what you lose when choosing v2.3 instead of v2.4.
...
**Save iTunes compatible grouping and work**
   ...
   .. only:: latex
      ...
      See the :doc:`Picard Tag Mapping <../appendices/tag_mapping_pdf>` section for details.
